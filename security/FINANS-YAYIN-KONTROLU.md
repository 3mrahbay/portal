...
- Tam iade / hatalı onay düzeltmesi atomik ters kayıtla işler. Özgün hareket silinmez; borç yeniden açılır. Personel açıklaması yalnız özel muhasebe kaydındadır. Gerçek para transferi yapmaz; kısmi iade desteklenmez.
...
3. Aday kural: veli başka öğrenci adına veya doğrudan onaylı bildirim oluşturamaz. Yerel Firestore Emulator ile 41 kontrol geçti: sahip veli, başka veli, muhasebe, öğretmen, danışma, PDR ve oturumsuz erişim; kısmi tahsilat, eşzamanlı mükerrer onay, fazla ödeme, ret, eşzamanlı ters kayıt ve veliye özel personel verisinin sızmaması doğrulandı. Kural henüz yayınlanmadı.
