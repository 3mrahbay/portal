      ...
      html += `
        <div style="padding:10px 12px; background:${stil ? stil.bg : 'white'}; border:1px solid ${stil ? stil.border : 'var(--gray-200)'}; border-radius:10px; margin-bottom:6px; display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px;">
          ...
          <div style="display:flex; gap:4px; flex-wrap:wrap;">
            ...
            <button onclick="devamsizlikIsaretle('${o.id}', 'gec')" title="Geç geldi" style="padding:6px 10px; background:${durum === 'gec' ? '#b8860b' : 'white'}; color:${durum === 'gec' ? 'white' : '#b8860b'}; border:1px solid #fde68a; border-radius:8px; font-size:12px; font-weight:700; cursor:pointer; min-width:40px;">🕐</button>
